...
public class Countries {
    ...
    static Countries register = new Countries();
    ...
    public static float enterOrValueFromUser() {
        ...
        System.out.println("Zadejte hodnotu VAT nebo tlačítko Enter:");
        Scanner scanner = new Scanner(System.in);
        String item = scanner.nextLine();
        if (item.isEmpty()){
            System.out.println("Zadali jste ENTER hodnota je nastavená na 20%\n");
            numberFromUser= 20;
        }
        else {
    ...
    public static void processingData () {
        ...
        System.out.println("Zadali jste: "+ numberFromUser);
        for (Country oneCountry: country){
            if (oneCountry.getFullDph()>numberFromUser && !oneCountry.specialDph) // větší než co zadal uživatel a nepoužívá se speciální dph
    ...
    public void writeCountryToFile(String filename) throws IOException {  // zápis do souboru, uloží noivý soubor
